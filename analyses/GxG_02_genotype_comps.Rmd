...
We can also quantify manipulation not in absolute terms, but relative to an expectation, namely the expected behavior of uninfected copepods. We had two groups of uninfected copepods: unexposed controls and exposed-but-uninfected copepods. Their behavior was very similar, which is consistent with other experiments.
