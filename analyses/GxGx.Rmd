...
Instead of asking how far a copepod moved in a given time frame, we can ask if it was moving at all.

CHECK CORRELATION BETWEEN HOP DISTANCE AND PROP MOVING! CHECK IF RESIDUALS DIFFER BTW TREATMENTS ACROSS RECORDING!
